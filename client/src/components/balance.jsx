...
import HeightTransition from './HeightTransition.custom.jsx';
...
export default (props) => {
    ...
    return (
        <div className="w3-dark-grey2 w3-full-height">
            <NavBar states={props.states} functions={props.functions} />
            <div className="w3-container">
                <div className="w3-panel w3-pale-yellow w3-leftbar w3-border-yellow w3-center navbar-margin">
            ...
            <div>
                <div className="w3-bar w3-border-bottom w3-black">
                    ...
                    <div className="w3-container city w3-animate-opacity w3-display-container w3-margin w3-light-grey">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <span onClick={() => setActiveTab('')} className="w3-button w3-display-topright w3-text-red">X</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan="2">
