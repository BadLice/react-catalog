...
export default function NewProductPusher(props) {
	...
	return (
		<div className="w3-modal-content new-product-modal w3-light-grey w3-animate-opacity w3-center">
					...
					<form ref={pImg}>
						<div className="w3-container w3-center">
							<div className="w3-margin ">
								...
								<label htmlFor="file" className="w3-button w3-blue w3-margin w3-hover-light-blue">{pFileUploaded.current && pFileUploaded.current.files.length <= 0 ? "Choose image" : "Change image"}</label>
							</div>
