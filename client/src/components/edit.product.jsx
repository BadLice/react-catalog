...
export default (props) => {
	...
	const saveProduct = () => {
		...
		let updateErrors = props.functions.saveProduct(product, pFileUploaded.current.files[0])
	...
	let idRandom = Date.now(); //used to img-edit-product id different
			...
			<form ref={pImg}>
				<div className="w3-container w3-center">
					<div className="w3-margin ">
						...
						<input type="file" ref={pFileUploaded} name={"img-edit-product" + idRandom} id={"img-edit-product" + idRandom} className="inputfile" onChange={() => showUploadedImage()} />
						<label htmlFor={"img-edit-product" + idRandom} className="w3-button w3-blue w3-margin w3-hover-light-blue">{pImgFileSrc === "/products-images/default/product-logo.jpg" ? "Choose image" : "Change image"}</label>
					</div>
